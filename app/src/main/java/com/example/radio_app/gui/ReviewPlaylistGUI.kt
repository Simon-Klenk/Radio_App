...
class ReviewPlaylistGUI : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.review_playlist)
        ...
        btnSend.setOnClickListener {
            ...
            if (valid(text)) {
                ...
                if (dataHandler.addReviewPlaylist(findViewById<EditText>(R.id.editTextTextMultiLine).text.toString()) == 201) {
